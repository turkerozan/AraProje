package org.cytoscapeapp.cyaraproje.internal.clustering;
...
public class EdgeRemoval extends Thread{
    ...
    public EdgeRemoval(CyNetwork currentnetwork, boolean larger, String edgeWeightAttribute, int edgesToRemove, ProjectStartMenu menu){
            ...
            if(larger){
                ...
                for(CyEdge edge: edgeList){
                    ...
                    CyRow row = edgeTable.getRow(edge.getSUID());
                        try {
                            temp = Double.parseDouble(""+ row.get(edgeWeightAttribute, ProjectStartMenu.edgeWeightAttributeColumn.getType()));
